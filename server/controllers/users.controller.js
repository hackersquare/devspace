...
usersController.LOGIN = (req, res) => {
  let options = {
    'redirect_uri': 'https://www.devspace-app.herokuapp.com:4200/home'
  }

  res.redirect('https://github.com/login/oauth/authorize?scope=user:email&client_id=' + process.env.GITHUB_ID + '&redirect_uri=https://www.devspace-app.herokuapp.com:4200/home')
}
